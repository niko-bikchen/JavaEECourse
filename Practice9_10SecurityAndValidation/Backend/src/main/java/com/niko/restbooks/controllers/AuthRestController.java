...
import com.niko.restbooks.security.AuthenticationManager;
import com.niko.restbooks.security.TokenProvider;
...
public class AuthRestController {
    ...
    @PostMapping("/sign-in")
    public ResponseEntity<UserEntity> signUserIn(@Valid @RequestBody UserEntity userLoginData, HttpServletResponse response) throws NotFoundException {
        ...
        if (passwordEncoder.matches(userLoginData.getPassword(), user.getPassword())) {
            ...
            log.info("User #" + user.getUserNumber() + " signed in");
    ...
    @PostMapping("/sign-up")
    public ResponseEntity<UserEntity> signUserUp(@Valid @RequestBody UserEntity user) throws BadRequestException {
        ...
        log.info("User #" + user.getUserNumber() + " signed up");
    ...
    public void logUserOut(HttpServletRequest request) {
        ...
        log.info("User #" + currentUser.getUserNumber() + " logged out");
